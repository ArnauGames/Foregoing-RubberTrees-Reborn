...
package net.mcreator.ifgretro.world.structure;
...
public class RubberTreeStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rubber_tree"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ifgretro:rubber_tree"), configuredFeature);
		}
	}
