...
package net.mcreator.ifgretro.item;
...
import net.mcreator.ifgretro.gui.PlasticBagGUIGuiWindow;
import net.mcreator.ifgretro.gui.PlasticBagGUIGui;
...
public class PlasticBagItem extends IfgretroModElements.ModElement {
	@ObjectHolder("ifgretro:plastic_bag")
	public static final Item block = null;

	public PlasticBagItem(IfgretroModElements instance) {
		super(instance, 11);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PlasticBagGUIGuiWindow) {
